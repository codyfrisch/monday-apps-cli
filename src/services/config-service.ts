...
export const ConfigService = {
  ...
  loadConfigToProcessEnv(directoryPath: string, fileName?: string, profileName?: string, ignoreProfiles?: boolean) {
    const data = readConfig(directoryPath, fileName ?? CONFIG_NAME);
