...
export const ConfigService = {
  ...
  loadConfigToProcessEnv(directoryPath: string, fileName?: string, tokenName?: string, ignoreTokenCommand?: boolean) {
    let data = readConfig(directoryPath, fileName ?? CONFIG_NAME);
